...
Run the loop.py from the command line and the insertion will be performed for each vessel in the existing vessel information database. Insertion for individual vessel with a given mmsi could also be performed from the command line as follow:
