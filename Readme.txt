This is the codebase used to build a prototype for RT-EEOI: a framework for real-time monitoring of Energy Efficiency Operating Index for marine vessles. For the publication, please refer to: https://doi.org/10.1016/j.energy.2017.12.088
